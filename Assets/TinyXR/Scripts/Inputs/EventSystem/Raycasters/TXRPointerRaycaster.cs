...
namespace TinyXRSDK
{
    ...
    public class TXRPointerRaycaster : EventCameraRaycaster
    {
        ...
        protected readonly List<TXRPointerEventData> buttonEventDataList = new List<TXRPointerEventData>();
        ...
        public TXRPointerEventData HoverEventData { get { return buttonEventDataList.Count > 0 ? buttonEventDataList[0] : null; } }
        public ReadOnlyCollection<TXRPointerEventData> ButtonEventDataList { get { return buttonEventDataList.AsReadOnly(); } }

        protected override void Start()
        {
            base.Start();
            ControllerTracker controllerTracker = GetComponentInParent<ControllerTracker>();
            RelatedHand = controllerTracker ? controllerTracker.defaultHandEnum : TXRInput.DomainHand;
            buttonEventDataList.Add(new TXRPointerEventData(this, EventSystem.current));
        }
        ...
        {
            return TXRInputModule.defaultRaycastComparer;
        }
        ...
        public virtual void PhysicsRaycast(Ray ray, float distance, List<RaycastResult> raycastResults)
        {
            ...
            for (int i = 0; i < hitCount; ++i)
            {
                raycastResults.Add(new RaycastResult
                {
                    ...
                    screenPosition = TXRInputModule.ScreenCenterPoint,
