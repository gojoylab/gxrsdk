...
namespace TinyXRSDK
{
    ...
    public class MultiScreenController : MonoBehaviour
    {
        ...
        [SerializeField]
        private TXRButton Trigger;
        [SerializeField]
        private TXRButton App;
        [SerializeField]
        private TXRButton Home;
        ...
        private void OnBtnTrigger(string key, GameObject go, RaycastResult racastInfo)
        {
            ...
            else if (key.Equals(TXRButton.Exit))
            {
                if (go == Trigger.gameObject)
                {
            ...
            if (go == Trigger.gameObject 
                &&(key.Equals(TXRButton.Hover) || key.Equals(TXRButton.Enter)))
            {
        ...
        private void AutoResizeButtons()
        {
            ...
            var resolution = PhoneScreen.Resolution;
            float t = resolution.x / PhoneScreen.DefaultWidth;
