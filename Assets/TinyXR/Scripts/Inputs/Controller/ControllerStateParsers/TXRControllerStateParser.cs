...
namespace TinyXRSDK
{
    ...
    /// <summary>
    /// The class parses the raw states of Controller to usable states by invoking parsing method every frame.
    /// </summary>
    public class TXRControllerStateParser : IControllerStateParser
    {
