...
in dropdown list of Player Settings > Other Settings > Color Space, choose 'Linear'.";
        ...
        private const string ignorePrefix = "TinyXR.ignore";
        ...
        public void OnGUI()
        {
            ...
            string aboutText = "This window provides tips to help fix common issues with the TinyXRSDK and your project.";
